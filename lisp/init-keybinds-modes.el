...
;; Date-prompt (small `*Calendar*') IJKL navigation is fixed up in
;; `lisp/init-keybinds-org-agenda.el' (`my/setup-org-read-date-keybinds',
;; hung off `minibuffer-setup-hook'), which covers every `org-read-date'
;; prompt regardless of mode -- no need to duplicate it here.
